...
public class Enemy : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        mRigidBody.transform.position = Vector3.MoveTowards(transform.position,nearestPlayer.transform.position,Time.deltaTime * speed);
        Vector3 newDirection = Vector3.RotateTowards(transform.forward, nearestPlayer.transform.position, Time.deltaTime * speed, 0.0f);
        //Debug.DrawRay(transform.position, newDirection, Color.red);
        mRigidBody.transform.rotation = Quaternion.LookRotation(newDirection);
    }
